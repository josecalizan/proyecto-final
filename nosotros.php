...
<body>
	...
	<div class="container">	
		<div class="row">
			...
			<div class="col-xs-9">
				<h3><p>Bienvenido a Bicycle-Shop tu tienda en linea</p> <p>donde encontraras todo tipo de bicycleta de tu gusto y mejor precio dados por nuestros responsables usuarios</p> <h3>
			</div>
...
<div class="fb-like" data-href="https://bisicle-shop.000webhostapp.com/view.php?id=56" data-layout="box_count" data-action="like" data-size="large" data-show-faces="true" data-share="true"></div>
			...
			<div class="col-xs-9">
				<h5><p>Webmaste: jose miguel calizan</p><h5>
				<h5><p>Direccion: las americas frente al itla@</p><h5>
				<h5><p>ID: 20142416</p><h5>
				<h5><p>USERNAME: Ghost</p><h5>
			</div>
